...
def _segm_mobilenet(name, backbone_name, num_classes, output_stride, pretrained_backbone):
    ...
    # print('*********************Print Backbone**********************')
    # print('backbone low is :', backbone.low_level_features)
    # print('backbone high is :', backbone.high_level_features)
...
def deeplabv3plus_mobilenetv3(num_classes=21, output_stride=8, pretrained_backbone=True):
    ...
    Args:
        ...
        pretrained_backbone (bool): If True, use the pretrained backbone.
    """
    return _load_model('deeplabv3plus', 'mobilenetv3', num_classes, output_stride=output_stride,
                       pretrained_backbone=pretrained_backbone)
